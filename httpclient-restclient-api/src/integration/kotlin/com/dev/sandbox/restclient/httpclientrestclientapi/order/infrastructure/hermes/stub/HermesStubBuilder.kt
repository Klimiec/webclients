package com.dev.sandbox.restclient.httpclientrestclientapi.order.infrastructure.hermes.stub
...
class HermesStubBuilder {
    ...
    private fun invoiceCreatedEventTopic(): MappingBuilder =
        WireMock.post(WireMock.urlPathEqualTo("/topics/topic-invoice-created"))
