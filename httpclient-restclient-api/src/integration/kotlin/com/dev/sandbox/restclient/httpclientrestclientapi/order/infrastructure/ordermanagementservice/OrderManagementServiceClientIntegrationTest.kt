...
import com.dev.sandbox.restclient.httpclientrestclientapi.order.infrastructure.util.ExternalServiceRedirectionException
import com.dev.sandbox.restclient.httpclientrestclientapi.order.infrastructure.util.ExternalServiceRequestValidationException
import com.dev.sandbox.restclient.httpclientrestclientapi.order.infrastructure.util.ExternalServiceResourceNotFoundException
import com.dev.sandbox.restclient.httpclientrestclientapi.order.infrastructure.util.ExternalServiceServerException
import com.dev.sandbox.restclient.httpclientrestclientapi.order.infrastructure.util.SERVICE_NAME
...
class OrderManagementServiceClientIntegrationTest :
    ...
    @Test
    fun `verify custom tags for order-management-service (metrics)`() {
        // given
        meterRegistry.clear()
        // and
        val clientId = anyClientId()
