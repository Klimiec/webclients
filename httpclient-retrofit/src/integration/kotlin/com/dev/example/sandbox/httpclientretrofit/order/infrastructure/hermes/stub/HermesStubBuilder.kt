...
import com.dev.example.sandbox.httpclientretrofit.order.infrastructure.hermes.HermesApi
...
class HermesStubBuilder {
    ...
    private fun invoiceCreatedEventTopic(): MappingBuilder =
        WireMock.post(WireMock.urlPathEqualTo("/topics/${HermesApi.TOPIC_INVOICE_CREATED_EVENT}"))
