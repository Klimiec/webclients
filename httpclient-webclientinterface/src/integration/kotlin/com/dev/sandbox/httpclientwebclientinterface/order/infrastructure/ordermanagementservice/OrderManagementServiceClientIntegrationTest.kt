...
import com.dev.sandbox.httpclientwebclientinterface.order.infrastructure.ordermanagementservice.stub.internal.OrderManagementServiceContractFixture.ordersPlacedBySomeCustomer
...
import com.dev.sandbox.httpclientwebclientinterface.order.infrastructure.util.ExternalServiceReadTimeoutException
import com.dev.sandbox.httpclientwebclientinterface.order.infrastructure.util.ExternalServiceRequestValidationException
import com.dev.sandbox.httpclientwebclientinterface.order.infrastructure.util.ExternalServiceResourceNotFoundException
import com.dev.sandbox.httpclientwebclientinterface.order.infrastructure.util.ExternalServiceServerException
import com.dev.sandbox.httpclientwebclientinterface.order.infrastructure.util.SERVICE_NAME
...
class OrderManagementServiceClientIntegrationTest : BaseIntegrationTest() {
    ...
    companion object {
        ...
        fun incorrectResponseBody(): Stream<Arguments> {
            return Stream.of(
                // service returns order with missing mandatory field orderId
