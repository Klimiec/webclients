...
import com.dev.sandbox.httpclientwebclientinterface.order.infrastructure.hermes.stub.HermesFixture
...
class HermesClientIntegrationTest : BaseIntegrationTest() {
    ...
    companion object {
        ...
        fun clientErrors(): Stream<Arguments> {
            return Stream.of(
                Arguments.of(ExternalServiceClientException::class.java, HttpStatus.UNAUTHORIZED.value(), null),
                Arguments.of(
